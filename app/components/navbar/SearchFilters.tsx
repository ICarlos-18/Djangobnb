const SearchFilters = () => {
    return (
        <div className="h-[64px] flex flex-row items-center justify-between border rounded-full">
            <div className="hidden lg:block">
                <div className="flex flex-row items-center justify-between">
                    ...
                    <div className="cursor-pointer w-h-[64px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
        ...
        <div className="p-2">
            <div className="cursor-pointer p-4 bg-airbnb hover:bg-airbnb-dark transmition rounded-full text-white">
            <svg 
                        viewBox="0 0 32 32" 
